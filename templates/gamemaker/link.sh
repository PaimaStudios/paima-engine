...
link_pkg "gamemaker" "contracts-evm"   "$SCRIPT_DIR/packages/contracts-evm"
link_pkg "gamemaker" "database"        "$SCRIPT_DIR/packages/database"
link_pkg "gamemaker" "node"            "$SCRIPT_DIR/packages/node"
link_pkg "gamemaker" "frontend"        "$SCRIPT_DIR/packages/frontend"
link_pkg "gamemaker" "tests"           "$SCRIPT_DIR/packages/tests"

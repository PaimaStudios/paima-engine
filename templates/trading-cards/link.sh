...
link_pkg "trading-cards" "contracts-evm"   "$SCRIPT_DIR/packages/contracts-evm"
link_pkg "trading-cards" "database"        "$SCRIPT_DIR/packages/database"
link_pkg "trading-cards" "node"            "$SCRIPT_DIR/packages/node"
link_pkg "trading-cards" "frontend"        "$SCRIPT_DIR/packages/frontend"
link_pkg "trading-cards" "tests"           "$SCRIPT_DIR/packages/tests"

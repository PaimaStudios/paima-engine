...
export function RegisterRoutes(app: Router) {
  ...
  app.get(
    ...
    function DryRunController_get(request: any, response: any, next: any) {
      const args = {
  ...
  app.get(
    ...
    function VersionController_get(request: any, response: any, next: any) {
      const args = {};
  ...
  app.get(
    ...
    function EmulatedBlockActiveController_get(request: any, response: any, next: any) {
      const args = {};
  ...
  app.get(
    ...
    function DeploymentBlockheightToEmulatedController_get(request: any, response: any, next: any) {
      const args = {
  ...
  app.get(
    ...
    function ConfirmInputAcceptanceController_get(request: any, response: any, next: any) {
      const args = {
        gameInput: { in: 'query', name: 'gameInput', required: true, dataType: 'string' },
        userAddress: { in: 'query', name: 'userAddress', required: true, dataType: 'string' },

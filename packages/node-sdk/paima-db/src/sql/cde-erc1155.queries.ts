...
const cdeErc1155DeleteIfZeroIR: any = {"usedParamSet":{"cde_id":true,"token_id":true,"wallet_address":true},"params":[{"name":"cde_id","required":true,"transform":{"type":"scalar"},"locs":[{"a":60,"b":67}]},{"name":"token_id","required":true,"transform":{"type":"scalar"},"locs":[{"a":84,"b":93}]},{"name":"wallet_address","required":true,"transform":{"type":"scalar"},"locs":[{"a":116,"b":131}]}],"statement":"DELETE FROM cde_erc1155_data\nWHERE balance = 0\nAND cde_id = :cde_id!\nAND token_id = :token_id!\nAND wallet_address = :wallet_address!"};

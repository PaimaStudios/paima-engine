...
const getLatestBlockHeightIR: any = {
  name: "getLatestBlockHeight",
  params: [],
  usedParamSet: {},
  statement: {
    body: "SELECT * FROM block_heights \nORDER BY block_height DESC\nLIMIT 1",
    loc: { a: 33, b: 95, line: 2, col: 0 },
  },
};
...
const getRandomnessIR: any = {
  name: "getRandomness",
  params: [],
  usedParamSet: {},
  statement: {
    body: "SELECT seed FROM block_heights\nORDER BY block_height DESC\nLIMIT 25",
    loc: { a: 125, b: 190, line: 7, col: 0 },
  },
};
  ...
  params: [
    {
      ...
      codeRefs: { used: [{ a: 287, b: 299, line: 13, col: 22 }] },
    },
  ],
  usedParamSet: { block_height: true },
  statement: {
    body: "SELECT * from scheduled_data\nWHERE block_height = :block_height!\nORDER BY id ASC",
    loc: { a: 236, b: 315, line: 12, col: 0 },
  },
};
  ...
  params: [
    {
      ...
      required: true,
      transform: { type: "scalar" },
      codeRefs: { used: [{ a: 407, b: 419, line: 18, col: 9 }] },
    },
    {
      name: "seed",
      required: true,
      transform: { type: "scalar" },
      codeRefs: { used: [{ a: 423, b: 427, line: 18, col: 25 }] },
    },
  ],
  usedParamSet: { block_height: true, seed: true },
  statement: {
    body: "INSERT INTO block_heights(block_height, seed)\nVALUES (:block_height!, :seed!)",
    loc: { a: 352, b: 428, line: 17, col: 0 },
  },
};
  ...
  params: [
    {
      ...
      required: true,
      transform: { type: "scalar" },
      codeRefs: { used: [{ a: 519, b: 531, line: 24, col: 22 }] },
    },
  ],
  usedParamSet: { block_height: true },
  statement: {
    body: "UPDATE block_heights\nSET\ndone = true\nWHERE block_height = :block_height!",
    loc: { a: 460, b: 531, line: 21, col: 0 },
  },
};
  ...
  params: [
    {
      ...
      required: true,
      transform: { type: "scalar" },
      codeRefs: { used: [{ a: 602, b: 604, line: 28, col: 12 }] },
    },
  ],
  usedParamSet: { id: true },
  statement: {
    body: "DELETE FROM scheduled_data\nWHERE id = :id!",
    loc: { a: 563, b: 604, line: 27, col: 0 },
  },
};
  ...
  params: [
    {
      ...
      required: false,
      transform: { type: "scalar" },
      codeRefs: { used: [{ a: 666, b: 670, line: 32, col: 15 }] },
    },
  ],
  usedParamSet: { nonce: true },
  statement: {
    body: "SELECT * FROM nonces\nWHERE nonce = :nonce",
    loc: { a: 630, b: 670, line: 31, col: 0 },
  },
};
  ...
  params: [
    {
      ...
      required: true,
      transform: { type: "scalar" },
      codeRefs: { used: [{ a: 747, b: 752, line: 36, col: 9 }] },
    },
    {
      name: "block_height",
      required: true,
      transform: { type: "scalar" },
      codeRefs: { used: [{ a: 756, b: 768, line: 36, col: 18 }] },
    },
  ],
  usedParamSet: { nonce: true, block_height: true },
  statement: {
    body: "INSERT INTO nonces(nonce, block_height)\nVALUES (:nonce!, :block_height!)",
    loc: { a: 698, b: 769, line: 35, col: 0 },
  },
};

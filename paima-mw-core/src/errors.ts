...
const PAIMA_MIDDLEWARE_ERROR_MESSAGES: PaimaErrorMessageMapping = {
  ...
  [PaimaMiddlewareErrorCode.METAMASK_LOGIN]: 'Unable to log into Metamask',
  [PaimaMiddlewareErrorCode.METAMASK_CHAIN_SWITCH]: 'Error while switching Metamask chain',
  [PaimaMiddlewareErrorCode.METAMASK_CHAIN_VERIFICATION]: 'Metamask chain verification failed',
  [PaimaMiddlewareErrorCode.METAMASK_WRONG_CHAIN]: 'Wrong chain currently selected in Metamask',
